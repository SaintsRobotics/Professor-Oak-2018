...
public class ColorSensorTCS34725 {
	...
	public ColorSensorTCS34725(Port port) {
        i2c = new I2C(port, DEVICE_ADDRESS);
	 ...
	 */
	public void enable() {
		i2c.write(ENABLE_REGISTER, ENABLE_VALUE_PON);
		zsleep(3);
		i2c.write(ENABLE_REGISTER, ENABLE_VALUE_PON | ENABLE_VALUE_AEN);
		initialized = true;
	}
	...
	public void setGain(Gain gain) {
		i2c.write(COMMAND_BIT | CONTROL_REGISTER, gain.value);
	}
	...
	public void setIntegrationTime(IntegrationTime time) {
		i2c.write(COMMAND_BIT | TIMING_REGISTER, time.value);
	}
	...
	public boolean isRGBCValid() {
		...
		return (getByte(STATUS_REGISTER) & 1) == 1;
	}
